...
import baobab.notebookfx.models.enums.TypeResource;
...
public class Resource implements Externalizable {
    ...
    // TYPE field
    // =========================================================================
    private ObjectProperty<TypeResource> type;
    private TypeResource _type;
    ...
    public ObjectProperty<TypeResource> typeProperty() {
        if (type == null) {
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        setType((TypeResource) in.readObject());
    }
